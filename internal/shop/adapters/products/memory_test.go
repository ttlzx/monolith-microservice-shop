...
func assertAllProducts(t *testing.T, repo *MemoryRepository, expectedProducts []products_domain.Product) {
...
func addProduct(t *testing.T, repo *MemoryRepository, id string) *products_domain.Product {
